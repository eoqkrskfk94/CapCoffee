...
그래서 다양한 브랜드의 다양한 캡슐들을 한눈에 보고 비교할 수 있는 어플리케이션을 개발하게 되었습니다. 
...
현재 여러 이미지 글 저작권 관련 문제로 해당 브랜드 캡슐 설명 및 이미지는 링크로 변경되어 있는 상태. 추후 해결이 되면 자체 데이터베이스 정보를 불러오는 형식의 어플 출시 예정
